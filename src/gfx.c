...
void gfx_open( int width, int height, const char *title, color fg, color bg)
{
	...
	// printf("blackColor : %d, whiteColor : %d\n", blackColor, whiteColor);

	int fg_color = fg == WHITE ? whiteColor : blackColor;
	int bg_color = bg == WHITE ? whiteColor : blackColor;

	gfx_window = XCreateSimpleWindow(gfx_display, DefaultRootWindow(gfx_display), 0, 0, width, height, 0, fg_color, bg_color);
